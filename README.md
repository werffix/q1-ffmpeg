...
Редактор метаданных видео + скачивание видео по URL (YouTube, TikTok, Instagram и др.).

## Функции

- **FFmpeg Tool** — загрузка видео, очистка/редактирование метаданных, встроенный плеер, рандомизация метаданных соцсетей
- **Downloader** — вставляешь ссылку, получаешь видео. Две кнопки: обычное скачивание и без метаданных
...
| POST | `/api/dl/download` | Скачивание по URL |
| POST | `/api/dl/download-stripped` | Скачивание по URL без метаданных |
